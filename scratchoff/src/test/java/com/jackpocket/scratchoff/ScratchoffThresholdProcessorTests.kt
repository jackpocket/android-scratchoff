...
class ScratchoffThresholdProcessorTests {
    ...
    fun testRunDoesNothingWhenImageNull() {
        ...
        val processor = object: ScratchoffThresholdProcessor(
            1, 1f, ScratchoffThresholdProcessor.Quality.HIGH, LoggingDelegate()
        ) {
    ...
    fun testActionDownWithoutMoveDoesNotDraw() {
        val processor = object: ScratchoffThresholdProcessor(
            5, 1f, ScratchoffThresholdProcessor.Quality.HIGH, LoggingDelegate()
        ) {
    ...
    fun testProcessImageTriggersThresholdReachedOnlyOnce() {
        val processor = object: ScratchoffThresholdProcessor(
            2, 0.5f, ScratchoffThresholdProcessor.Quality.HIGH, LoggingDelegate()
        ) {
            override fun scheduleNextThresholdEvaluation() {}
        }
    ...
    fun testScratchPercentNotUpdatesAfterThresholdReachedTriggered() {
        val processor = object: ScratchoffThresholdProcessor(
            1, 0.5f, ScratchoffThresholdProcessor.Quality.HIGH, LoggingDelegate()
        ) {
            override fun scheduleNextThresholdEvaluation() {}
        }

        processor.prepare(intArrayOf(1, 10));
        processor.addScratchPathPoints(
            listOf(
                ScratchPathPoint(0, 0f, 0f, MotionEvent.ACTION_DOWN),
    ...
    fun testPathRedrawDoesNotAffectHistoricalScratchPercentRedraw() {
        ...
        val processor = object: ScratchoffThresholdProcessor(
            30, 1f, ScratchoffThresholdProcessor.Quality.HIGH, LoggingDelegate()
        ) {
            override fun scheduleNextThresholdEvaluation() {}
        }
    ...
    fun constrainAccuracyQualityBoundedToMinMax() {
        assertEquals(
            1f,
            ScratchoffThresholdProcessor.constrainAccuracyQuality(
                100, ScratchoffThresholdProcessor.Quality.HIGH, intArrayOf(100, 100)
            )
        )
        assertEquals(
            1f,
            ScratchoffThresholdProcessor.constrainAccuracyQuality(
                10, ScratchoffThresholdProcessor.Quality.HIGH, intArrayOf(100, 100)
            )
        )
        assertEquals(
            1f,
            ScratchoffThresholdProcessor.constrainAccuracyQuality(
                1, ScratchoffThresholdProcessor.Quality.HIGH, intArrayOf(100, 100)
            )
        )
        ...
        assertEquals(
            0.5f,
            ScratchoffThresholdProcessor.constrainAccuracyQuality(
                100, ScratchoffThresholdProcessor.Quality.MEDIUM, intArrayOf(100, 100)
            )
        )
        assertEquals(
            0.5f,
            ScratchoffThresholdProcessor.constrainAccuracyQuality(
                10, ScratchoffThresholdProcessor.Quality.MEDIUM, intArrayOf(100, 100)
            )
        )
        assertEquals(
            1f,
            ScratchoffThresholdProcessor.constrainAccuracyQuality(
                1, ScratchoffThresholdProcessor.Quality.MEDIUM, intArrayOf(100, 100)
            )
        )
        ...
        assertEquals(
            0.01f,
            ScratchoffThresholdProcessor.constrainAccuracyQuality(
                100, ScratchoffThresholdProcessor.Quality.LOW, intArrayOf(100, 100)
            )
        )
        assertEquals(
            0.1f,
            ScratchoffThresholdProcessor.constrainAccuracyQuality(
                10, ScratchoffThresholdProcessor.Quality.LOW, intArrayOf(100, 100)
            )
        )
        assertEquals(
            1f,
            ScratchoffThresholdProcessor.constrainAccuracyQuality(
                1, ScratchoffThresholdProcessor.Quality.LOW, intArrayOf(100, 100)
            )
        )
    }
